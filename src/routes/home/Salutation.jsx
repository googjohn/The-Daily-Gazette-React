  ...
  return (
    <div id="salutation-date" className="mb-1.5 flex justify-between items-center w-full">
      <div id="salutation" className="text-black">
        <h1 className="text-[1.6rem] text-(--red) font-semibold">Welcome to The Daily Gazette!</h1>
      </div>
      <div id="date-time" className="text-(--gray-50) text-[1.15rem] text-shadow-(--ts-whiteup-blackdown) flex gap-2.5">
