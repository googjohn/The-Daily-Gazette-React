...
function MarketChartWidget() {
  ...
  return (
    <div className="tradingview-widget-container rounded-lg shadow-[var(--bs-cards-lup-ddown)] w-full overflow-hidden" ref={container} style={{ height: "100%", width: "100%" }}>
...
export default memo(MarketChartWidget);
